...
class addTest8 extends CI_Controller {
		...
		if(isset($_POST['save']))
		{
		  ...
		  $this->form_validation->set_rules('order', 'Answer', 'requered');
			...
			if($this->form_validation->run())
			{
				...
				redirect('admin/addTest8/addquestion/'.$task_id, 'refresh');
			}
			else
			{
...
/*...............................................................*/
			...
			if($query -> num_rows() >0 )
			{
				...
				foreach($result as $row)
				{
				 ...
				 $content['action'][$q] = '<a href="'.base_url().'admin/addTest8/edit/'.$row->id.'/'.$row->task_id.'">Edit</a>';
				 $content['action'][$q] .=' | <a href="'.base_url().'admin/addTest8/delete/'.$row->id.'/'.$row->task_id.'">Delete</a>';
