...
class pager extends CI_Controller {
  ...
  private $names = array('tom', 'sally', 'fred', 'max', 'timmy', 'russel', 'peter', 'angie', 'megan', 'thomas', 'mitchell', 'sally', 'wilma', 'bob', 'alice', 'rick', 'james', 'walker', 'johnny', 'tj', 'thomas', 'jackson', 'sigmond', 'maxwell', 'sam', 'freddy', 'don', 'johnny', 'tj', 'thomas', 'jackson', 'sigmond', 'maxwell', 'sam', 'freddy', 'don', 'johnny', 'tj', 'thomas', 'jackson', 'sigmond', 'maxwell', 'sam', 'freddy', 'don', 'johnny', 'tj', 'thomas', 'jackson', 'sigmond', 'maxwell', 'sam', 'freddy', 'don', 'johnny', 'tj', 'thomas', 'jackson', 'sigmond', 'maxwell', 'sam', 'freddy', 'don', 'johnny', 'tj', 'thomas', 'jackson', 'sigmond', 'maxwell', 'sam', 'freddy', 'don', 'johnny', 'tj', 'thomas', 'jackson', 'sigmond', 'maxwell', 'sam', 'freddy', 'don', 'johnny', 'tj', 'thomas', 'jackson', 'sigmond', 'maxwell', 'sam', 'freddy', 'don', 'johnny', 'tj', 'thomas', 'jackson', 'sigmond', 'maxwell', 'sam', 'freddy', 'don', 'johnny', 'tj', 'thomas', 'jackson', 'sigmond', 'maxwell', 'sam', 'freddy', 'don', 'johnny', 'tj', 'thomas', 'jackson', 'sigmond', 'maxwell', 'sam', 'freddy', 'don', 'johnny', 'tj', 'thomas', 'jackson', 'sigmond', 'maxwell', 'sam', 'freddy', 'don');
  ...
  /* The index() function gets called on page load. */
    ...
    $config['base_url'] = base_url().'admin/pager/index';
    ...
    /* Load the view and pass the variables */
		$this->load->view('admin/deeps_pager', $data);
	}
